...
for %%F in (patchy.data patchy.wasm patchy.js patchy.worker.js qtloader.js patchy-logo.png .htaccess patchy.html index.html) do (
...
scp "%SITE_DIR%\patchy.data" "%SITE_DIR%\patchy.wasm" "%SITE_DIR%\patchy.js" "%SITE_DIR%\patchy.worker.js" "%SITE_DIR%\qtloader.js" "%SITE_DIR%\patchy-logo.png" "%SITE_DIR%\.htaccess" "%SITE_DIR%\patchy.html" "%SITE_DIR%\index.html" rtsoft@rtsoft.com:www/patchy/
if errorlevel 1 goto fail
