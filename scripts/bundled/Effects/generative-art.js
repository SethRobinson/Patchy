...
if (!doc) {
  ...
  // Scale the particle count with the canvas so small and large documents both
  // come out evenly covered.
  var PARTICLES = Math.max(200, Math.min(4000, Math.round(W * H / 440)));
  var STEPS = 260;
