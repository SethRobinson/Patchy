...
void MainWindow::create_docks() {
  ...
  add_button->setIcon(simple_icon(QStringLiteral("new"), &ThemePalette::icon_ink));
  add_folder_button->setIcon(simple_icon(QStringLiteral("dir"), &ThemePalette::icon_ink));
  adjustment_button->setIcon(simple_icon(QStringLiteral("ADJ"), &ThemePalette::icon_ink));
  add_mask_button->setIcon(simple_icon(QStringLiteral("mask"), &ThemePalette::icon_ink));
  duplicate_button->setIcon(simple_icon(QStringLiteral("dup"), &ThemePalette::icon_ink));
  rename_button->setIcon(simple_icon(QStringLiteral("RN"), &ThemePalette::icon_ink));
  animation_button->setIcon(simple_icon(QStringLiteral("film"), &ThemePalette::icon_ink));
  delete_button->setIcon(simple_icon(QStringLiteral("trash"), &ThemePalette::icon_ink));
